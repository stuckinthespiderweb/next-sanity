...
export default async function Home() {
  ...
  <div className="max-w-5xl mx-auto py-20">
    <h1 className="text-7xl font-extrabold">Hello I am <span className="bg-gradient-to-r from-orange-400 via-purple-600 bg-clip-text text-transparent">Usermind</span></h1>
